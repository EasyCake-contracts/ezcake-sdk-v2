...
(function (ChainId) {
  ChainId[ChainId["KAI"] = 24] = "KAI";
  ChainId[ChainId["MAINNET"] = 1] = "MAINNET";
  ChainId[ChainId["ROPSTEN"] = 3] = "ROPSTEN";
  ChainId[ChainId["RINKEBY"] = 4] = "RINKEBY";
  ChainId[ChainId["G\xD6RLI"] = 5] = "G\xD6RLI";
  ChainId[ChainId["KOVAN"] = 42] = "KOVAN";
  ChainId[ChainId["TOMO"] = 88] = "TOMO";
  ChainId[ChainId["TOMO_TESTNET"] = 89] = "TOMO_TESTNET";
...
var FACTORY_ADDRESS = (_FACTORY_ADDRESS = {}, _FACTORY_ADDRESS[exports.ChainId.BSC_TESTNET] = '0xB0C6536fB1A4F76be4e1390b8328980499DdA146', _FACTORY_ADDRESS[exports.ChainId.BSC] = '0xcA143Ce32Fe78f1f7019d7d551a6402fC5350c73', _FACTORY_ADDRESS[exports.ChainId.ONUS] = '0xA5DA4dC244c7aD33a0D8a10Ed5d8cFf078E86Ef3', _FACTORY_ADDRESS);
var INIT_CODE_HASH = (_INIT_CODE_HASH = {}, _INIT_CODE_HASH[exports.ChainId.BSC_TESTNET] = '0x2d7469ebcfbf32f8f4cf914ef1a54a6813d9541cbfa7d578e3a107003da7021a', _INIT_CODE_HASH[exports.ChainId.BSC] = '0x00fb7f630766e6a796048ea87d01acd3068e8ff67d078148a3fa3f4a84f69bd5', _INIT_CODE_HASH[exports.ChainId.ONUS] = '0x5393060e4ffa74ba02e5aaed6c5ccdba4186aa7759b8cf1fa32810a204843ac4', _INIT_CODE_HASH);
...
var FEES_NUMERATOR = (_FEES_NUMERATOR = {}, _FEES_NUMERATOR[exports.ChainId.KAI] = /*#__PURE__*/JSBI.BigInt(9975), _FEES_NUMERATOR[exports.ChainId.ONUS] = /*#__PURE__*/JSBI.BigInt(9970), _FEES_NUMERATOR[exports.ChainId.ONUS_TESTNET] = /*#__PURE__*/JSBI.BigInt(9970), _FEES_NUMERATOR[exports.ChainId.BSC_TESTNET] = /*#__PURE__*/JSBI.BigInt(9970), _FEES_NUMERATOR[exports.ChainId.BSC] = /*#__PURE__*/JSBI.BigInt(9970), _FEES_NUMERATOR);
...
Currency.ETHER = /*#__PURE__*/new Currency(18, 'ETH', 'ETH', exports.ChainId.MAINNET);
Currency.KAI = /*#__PURE__*/new Currency(18, 'KAI', 'KAI', exports.ChainId.KAI);
Currency.BNB = /*#__PURE__*/new Currency(18, 'BNB', 'BNB', exports.ChainId.BSC);
Currency.BNB_TESTNET = /*#__PURE__*/new Currency(18, 'BNB', 'BNB', exports.ChainId.BSC_TESTNET);
Currency.ONUS = /*#__PURE__*/new Currency(18, 'ONUS', 'ONUS', exports.ChainId.ONUS);
Currency.ONUS_TESTNET = /*#__PURE__*/new Currency(18, 'ONUS', 'ONUS', exports.ChainId.ONUS_TESTNET);
Currency.ONE = /*#__PURE__*/new Currency(18, 'ONE', 'ONE', exports.ChainId.HARMONY);
var ETHER = Currency.ETHER,
    KAI = Currency.KAI,
    ONUS = Currency.ONUS,
    ONUS_TESTNET = Currency.ONUS_TESTNET,
    BNB = Currency.BNB,
    BNB_TESTNET = Currency.BNB_TESTNET,
    ONE$1 = Currency.ONE;
var NativeCurrency = (_NativeCurrency = {}, _NativeCurrency[exports.ChainId.KAI] = KAI, _NativeCurrency[exports.ChainId.BSC] = BNB, _NativeCurrency[exports.ChainId.BSC_TESTNET] = BNB_TESTNET, _NativeCurrency[exports.ChainId.ONUS_TESTNET] = ONUS_TESTNET, _NativeCurrency[exports.ChainId.ONUS] = ONUS, _NativeCurrency[exports.ChainId.HARMONY] = ONE$1, _NativeCurrency);
...
var WETH = (_WETH = {}, _WETH[exports.ChainId.KAI] = /*#__PURE__*/new Token(exports.ChainId.KAI, '0xAF984E23EAA3E7967F3C5E007fbe397D8566D23d', 18, 'WKAI', 'Wrapped KAI'), _WETH[exports.ChainId.BSC] = /*#__PURE__*/new Token(exports.ChainId.BSC, '0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c', 18, 'WBNB', 'Wrapped BNB'), _WETH[exports.ChainId.BSC_TESTNET] = /*#__PURE__*/new Token(exports.ChainId.BSC_TESTNET, '0xae13d989dac2f0debff460ac112a837c89baa7cd', 18, 'WBNB', 'Wrapped BNB'), _WETH[exports.ChainId.ONUS] = /*#__PURE__*/new Token(exports.ChainId.ONUS, '0x4c761E48d1E735af551cc38ABCBDCe1d7FaaC6E4', 18, 'WONUS', 'Wrapped ONUS'), _WETH[exports.ChainId.ONUS_TESTNET] = /*#__PURE__*/new Token(exports.ChainId.ONUS_TESTNET, '0x93c1e164944D1B741E4aa579cd7e0b0257A57A9c', 18, 'WONUS', 'Wrapped ONUS'), _WETH[exports.ChainId.HARMONY] = /*#__PURE__*/new Token(exports.ChainId.ONUS, '0xcf664087a5bb0237a0bad6742852ec6c8d69a27a', 18, 'WONE', 'Wrapped ONE'), _WETH);
...
var CurrencyAmount = /*#__PURE__*/function (_Fraction) {
  ...
  CurrencyAmount.ether = function ether(amount, chainId) {
    return new CurrencyAmount(NativeCurrency[chainId || exports.ChainId.MAINNET], amount);
  };
...
var Price = /*#__PURE__*/function (_Fraction) {
  ...
  _proto.quote = function quote(currencyAmount) {
    ...
    return CurrencyAmount.ether(_Fraction.prototype.multiply.call(this, currencyAmount.raw).quotient, currencyAmount.currency.chainId);
  };
...
var Pair = /*#__PURE__*/function () {
  function Pair(tokenAmountA, tokenAmountB) {
    ...
    this.liquidityToken = new Token(tokenAmounts[0].token.chainId, Pair.getAddress(tokenAmounts[0].token, tokenAmounts[1].token), 18, 'KLP', 'KAIDEX LP Token');
...
var Route = /*#__PURE__*/function () {
  function Route(pairs, input, output) {
    ...
    !(input instanceof Token && pairs[0].involvesToken(input) || input === NativeCurrency[pairs[0].chainId] && pairs[0].involvesToken(WETH[pairs[0].chainId])) ?  invariant(false, 'INPUT')  : void 0;
    !(typeof output === 'undefined' || output instanceof Token && pairs[pairs.length - 1].involvesToken(output) || output === NativeCurrency[pairs[0].chainId] && pairs[pairs.length - 1].involvesToken(WETH[pairs[0].chainId])) ?  invariant(false, 'OUTPUT')  : void 0;
...
function wrappedAmount(currencyAmount, chainId) {
  ...
  if (currencyAmount.currency === NativeCurrency[chainId]) return new TokenAmount(WETH[chainId], currencyAmount.raw);
    invariant(false, 'CURRENCY')  ;
}

function wrappedCurrency(currency, chainId) {
  if (currency instanceof Token) return currency;
  if (currency === NativeCurrency[chainId]) return WETH[chainId];
    invariant(false, 'CURRENCY')  ;
}
/**
...
var Trade = /*#__PURE__*/function () {
  function Trade(route, amount, tradeType) {
    ...
    this.inputAmount = tradeType === exports.TradeType.EXACT_INPUT ? amount : route.input === NativeCurrency[route.chainId] ? CurrencyAmount.ether(amounts[0].raw, route.chainId) : amounts[0];
    this.outputAmount = tradeType === exports.TradeType.EXACT_OUTPUT ? amount : route.output === NativeCurrency[route.chainId] ? CurrencyAmount.ether(amounts[amounts.length - 1].raw, route.chainId) : amounts[amounts.length - 1];
...
var Router = /*#__PURE__*/function () {
  ...
  Router.swapCallParameters = function swapCallParameters(trade, options) {
    var etherIn = trade.inputAmount.currency === NativeCurrency[trade.route.chainId];
    var etherOut = trade.outputAmount.currency === NativeCurrency[trade.route.chainId]; // the router does not support both ether in and out
    ...
    switch (trade.tradeType) {
      case exports.TradeType.EXACT_INPUT:
        if (etherIn) {
          methodName = trade.route.chainId === exports.ChainId.KAI ? useFeeOnTransfer ? 'swapExactKAIForTokensSupportingFeeOnTransferTokens' : 'swapExactKAIForTokens' : useFeeOnTransfer ? 'swapExactETHForTokensSupportingFeeOnTransferTokens' : 'swapExactETHForTokens'; // (uint amountOutMin, address[] calldata path, address to, uint deadline)

          args = [amountOut, path, to, deadline];
          value = amountIn;
        } else if (etherOut) {
          methodName = trade.route.chainId === exports.ChainId.KAI ? useFeeOnTransfer ? 'swapExactTokensForKAISupportingFeeOnTransferTokens' : 'swapExactTokensForKAI' : useFeeOnTransfer ? 'swapExactTokensForETHSupportingFeeOnTransferTokens' : 'swapExactTokensForETH'; // (uint amountIn, uint amountOutMin, address[] calldata path, address to, uint deadline)
      ...
      case exports.TradeType.EXACT_OUTPUT:
        ...
        if (etherIn) {
          methodName = trade.route.chainId === exports.ChainId.KAI ? 'swapKAIForExactTokens' : 'swapETHForExactTokens'; // (uint amountOut, address[] calldata path, address to, uint deadline)

          args = [amountOut, path, to, deadline];
          value = amountIn;
        } else if (etherOut) {
          methodName = trade.route.chainId === exports.ChainId.KAI ? 'swapTokensForExactKAI' : 'swapTokensForExactETH'; // (uint amountOut, uint amountInMax, address[] calldata path, address to, uint deadline)
...
exports.JSBI = JSBI;
exports.BNB = BNB;
exports.BNB_TESTNET = BNB_TESTNET;
...
exports.ONE = ONE$1;
exports.ONUS = ONUS;
exports.ONUS_TESTNET = ONUS_TESTNET;
exports.Pair = Pair;
