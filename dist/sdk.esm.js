...
var FACTORY_ADDRESS = (_FACTORY_ADDRESS = {}, _FACTORY_ADDRESS[ChainId.BSC_TESTNET] = '0xB0C6536fB1A4F76be4e1390b8328980499DdA146', _FACTORY_ADDRESS[ChainId.BSC] = '0xcA143Ce32Fe78f1f7019d7d551a6402fC5350c73', _FACTORY_ADDRESS[ChainId.ONUS] = '0xA5DA4dC244c7aD33a0D8a10Ed5d8cFf078E86Ef3', _FACTORY_ADDRESS);
var INIT_CODE_HASH = (_INIT_CODE_HASH = {}, _INIT_CODE_HASH[ChainId.BSC_TESTNET] = '0x2d7469ebcfbf32f8f4cf914ef1a54a6813d9541cbfa7d578e3a107003da7021a', _INIT_CODE_HASH[ChainId.BSC] = '0x00fb7f630766e6a796048ea87d01acd3068e8ff67d078148a3fa3f4a84f69bd5', _INIT_CODE_HASH[ChainId.ONUS] = '0x5393060e4ffa74ba02e5aaed6c5ccdba4186aa7759b8cf1fa32810a204843ac4', _INIT_CODE_HASH);
...
var FEES_NUMERATOR = (_FEES_NUMERATOR = {}, _FEES_NUMERATOR[ChainId.KAI] = /*#__PURE__*/JSBI.BigInt(9975), _FEES_NUMERATOR[ChainId.ONUS] = /*#__PURE__*/JSBI.BigInt(9970), _FEES_NUMERATOR[ChainId.ONUS_TESTNET] = /*#__PURE__*/JSBI.BigInt(9970), _FEES_NUMERATOR[ChainId.BSC_TESTNET] = /*#__PURE__*/JSBI.BigInt(9970), _FEES_NUMERATOR[ChainId.BSC] = /*#__PURE__*/JSBI.BigInt(9970), _FEES_NUMERATOR);
...
Currency.ETHER = /*#__PURE__*/new Currency(18, 'ETH', 'ETH', ChainId.MAINNET);
Currency.KAI = /*#__PURE__*/new Currency(18, 'KAI', 'KAI', ChainId.KAI);
Currency.BNB = /*#__PURE__*/new Currency(18, 'BNB', 'BNB', ChainId.BSC);
Currency.BNB_TESTNET = /*#__PURE__*/new Currency(18, 'BNB', 'BNB', ChainId.BSC_TESTNET);
Currency.ONUS = /*#__PURE__*/new Currency(18, 'ONUS', 'ONUS', ChainId.ONUS);
Currency.ONUS_TESTNET = /*#__PURE__*/new Currency(18, 'ONUS', 'ONUS', ChainId.ONUS_TESTNET);
Currency.ONE = /*#__PURE__*/new Currency(18, 'ONE', 'ONE', ChainId.HARMONY);
var ETHER = Currency.ETHER,
    ...
    ONE$1 = Currency.ONE;
var NativeCurrency = (_NativeCurrency = {}, _NativeCurrency[ChainId.KAI] = KAI, _NativeCurrency[ChainId.BSC] = BNB, _NativeCurrency[ChainId.BSC_TESTNET] = BNB_TESTNET, _NativeCurrency[ChainId.ONUS_TESTNET] = ONUS_TESTNET, _NativeCurrency[ChainId.ONUS] = ONUS, _NativeCurrency[ChainId.HARMONY] = ONE$1, _NativeCurrency);
...
var WETH = (_WETH = {}, _WETH[ChainId.KAI] = /*#__PURE__*/new Token(ChainId.KAI, '0xAF984E23EAA3E7967F3C5E007fbe397D8566D23d', 18, 'WKAI', 'Wrapped KAI'), _WETH[ChainId.BSC] = /*#__PURE__*/new Token(ChainId.BSC, '0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c', 18, 'WBNB', 'Wrapped BNB'), _WETH[ChainId.BSC_TESTNET] = /*#__PURE__*/new Token(ChainId.BSC_TESTNET, '0xae13d989dac2f0debff460ac112a837c89baa7cd', 18, 'WBNB', 'Wrapped BNB'), _WETH[ChainId.ONUS] = /*#__PURE__*/new Token(ChainId.ONUS, '0x4c761E48d1E735af551cc38ABCBDCe1d7FaaC6E4', 18, 'WONUS', 'Wrapped ONUS'), _WETH[ChainId.ONUS_TESTNET] = /*#__PURE__*/new Token(ChainId.ONUS_TESTNET, '0x93c1e164944D1B741E4aa579cd7e0b0257A57A9c', 18, 'WONUS', 'Wrapped ONUS'), _WETH[ChainId.HARMONY] = /*#__PURE__*/new Token(ChainId.ONUS, '0xcf664087a5bb0237a0bad6742852ec6c8d69a27a', 18, 'WONE', 'Wrapped ONE'), _WETH);
...
var CurrencyAmount = /*#__PURE__*/function (_Fraction) {
  ...
  CurrencyAmount.ether = function ether(amount, chainId) {
    return new CurrencyAmount(NativeCurrency[chainId || ChainId.MAINNET], amount);
  };
...
var Route = /*#__PURE__*/function () {
  function Route(pairs, input, output) {
    ...
    !(input instanceof Token && pairs[0].involvesToken(input) || input === NativeCurrency[pairs[0].chainId] && pairs[0].involvesToken(WETH[pairs[0].chainId])) ? process.env.NODE_ENV !== "production" ? invariant(false, 'INPUT') : invariant(false) : void 0;
    !(typeof output === 'undefined' || output instanceof Token && pairs[pairs.length - 1].involvesToken(output) || output === NativeCurrency[pairs[0].chainId] && pairs[pairs.length - 1].involvesToken(WETH[pairs[0].chainId])) ? process.env.NODE_ENV !== "production" ? invariant(false, 'OUTPUT') : invariant(false) : void 0;
...
var Trade = /*#__PURE__*/function () {
  function Trade(route, amount, tradeType) {
    ...
    this.inputAmount = tradeType === TradeType.EXACT_INPUT ? amount : route.input === NativeCurrency[route.chainId] ? CurrencyAmount.ether(amounts[0].raw, route.chainId) : amounts[0];
    this.outputAmount = tradeType === TradeType.EXACT_OUTPUT ? amount : route.output === NativeCurrency[route.chainId] ? CurrencyAmount.ether(amounts[amounts.length - 1].raw, route.chainId) : amounts[amounts.length - 1];
  ...
  Router.swapCallParameters = function swapCallParameters(trade, options) {
    ...
    switch (trade.tradeType) {
      case TradeType.EXACT_INPUT:
        if (etherIn) {
          methodName = trade.route.chainId === ChainId.KAI ? useFeeOnTransfer ? 'swapExactKAIForTokensSupportingFeeOnTransferTokens' : 'swapExactKAIForTokens' : useFeeOnTransfer ? 'swapExactETHForTokensSupportingFeeOnTransferTokens' : 'swapExactETHForTokens'; // (uint amountOutMin, address[] calldata path, address to, uint deadline)

          args = [amountOut, path, to, deadline];
          value = amountIn;
        } else if (etherOut) {
          methodName = trade.route.chainId === ChainId.KAI ? useFeeOnTransfer ? 'swapExactTokensForKAISupportingFeeOnTransferTokens' : 'swapExactTokensForKAI' : useFeeOnTransfer ? 'swapExactTokensForETHSupportingFeeOnTransferTokens' : 'swapExactTokensForETH'; // (uint amountIn, uint amountOutMin, address[] calldata path, address to, uint deadline)
      ...
      case TradeType.EXACT_OUTPUT:
        ...
        if (etherIn) {
          methodName = trade.route.chainId === ChainId.KAI ? 'swapKAIForExactTokens' : 'swapETHForExactTokens'; // (uint amountOut, address[] calldata path, address to, uint deadline)

          args = [amountOut, path, to, deadline];
          value = amountIn;
        } else if (etherOut) {
          methodName = trade.route.chainId === ChainId.KAI ? 'swapTokensForExactKAI' : 'swapTokensForExactETH'; // (uint amountOut, uint amountInMax, address[] calldata path, address to, uint deadline)
...
export { BNB, BNB_TESTNET, ChainId, Currency, CurrencyAmount, ETHER, FACTORY_ADDRESS, FEES_NUMERATOR, Fetcher, Fraction, INIT_CODE_HASH, InsufficientInputAmountError, InsufficientReservesError, KAI, MINIMUM_LIQUIDITY, NativeCurrency, ONE$1 as ONE, ONUS, ONUS_TESTNET, Pair, Percent, Price, Rounding, Route, Router, Token, TokenAmount, Trade, TradeType, WETH, currencyEquals, inputOutputComparator, tradeComparator };
